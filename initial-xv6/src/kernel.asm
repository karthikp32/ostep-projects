...
8010504d:	58                   	pop    %eax
8010504e:	5a                   	pop    %edx
8010504f:	68 38 78 10 80       	push   $0x80107838
...
80105068:	68 37 78 10 80       	push   $0x80107837
